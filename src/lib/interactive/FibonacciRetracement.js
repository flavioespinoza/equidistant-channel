...
class FibonacciRetracement extends Component {
  ...
  render () {
    ...
    const currentPositionStroke = utils.color().side(side)
    ...
    const currentRetracement = isDefined(current) && isDefined(current.x2)
      ? <EachFibRetracement interactive={false}
                            type={'RAY'}
...
FibonacciRetracement.defaultProps = {
  ...
  currentPositionStroke: 'white',
  currentPositionOpacity: 1,
  currentPositionStrokeWidth: 1,
  currentPositionRadius: 36,
